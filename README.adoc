...
:page-title: Creating a RESTful web service
:page-seo-title: Building a simple RESTful Java microservice using JAX-RS and JSON-B
:page-seo-description: A getting started tutorial with examples of how to create a RESTful Java microservice in Open Liberty using the Java API for RESTful Web Services (JAX-RS) and JSON Binding (JSON-B).
